...
namespace ns3 {
    ...
    */
    // std::vector<MulticastUdpInfo> read_udp_burst_schedule(const std::string& filename, Ptr<Topology> topology, const int64_t simulation_end_time_ns) {
    ...
    //             // Put into schedule
    //             schedule.push_back(MulticastUdpInfo(udp_burst_id, from_node_id, to_node_id, target_rate_megabit_per_s, start_time_ns, duration_ns, additional_parameters, metadata));
